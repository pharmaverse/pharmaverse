...
| ----------- | ----------- | ----------- |
| Join pharmaverse.slack.com using [link](https://pharmaverse.slack.com) and set up an open channel for your package and set up notifications. You may also wish to set-up private channels here for other purposes such as only for development or testing teams | Join pharmaverse.slack.com using [link](https://pharmaverse.slack.com) and the channels of any package you are using and set up notifications | Slack user channel: use package name, _e.g. admiral_; Dev team: add “_dev”, _e.g. admiral_dev_; Testing team: add “_testing”, _e.g. admiral_testing_ |
